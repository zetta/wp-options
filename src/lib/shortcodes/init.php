 ...
 */
	...
	add_action('admin_footer', 'storelicious_shorcodes_functions');
	add_action('wp_footer', 'storelicious_shorcodes_functions');
	function storelicious_shorcodes_functions() {
		$output = "
 ...
 ************************************************************************************/
	...
	//SQUARE BUTTON
	include('functions/code/btn_square.php');
	//ROUNDED BUTTON
	include('functions/code/btn_round.php');
	//ICON BUTTON
	include('functions/code/btn_icon.php');
	//CHUNKY BUTTON
	include('functions/code/btn_chunky.php');
	//LINKS
	include('functions/code/links.php');
	//LIST
	include('functions/code/lists.php');
	//TABS
	include('functions/code/tabs.php');
	//SLIDE
	include('functions/code/slide.php');
	//TOGGLE
	include('functions/code/toggle.php');
	//BLOCK
	include('functions/code/block.php');
	//RELATED
	include('functions/code/related.php');
	//RELATED THUMBNAIL
	include('functions/code/related_thumb.php');
	//NOTIFICATIONS
	include('functions/code/notifications.php');
	//MISC
	include('functions/code/misc.php');
	//COLUMNS
	include('functions/code/columns.php');
	//TOOLTIPS
	include('functions/code/tooltip.php');
	//PROTECTED CONTENT
	include('functions/code/protected.php');
	//ACCORDION
	include('functions/code/accordion.php');
	//STORELICIOUS
	include('functions/code/storelicious.php');
	//GALLERY
	include('functions/code/gallery.php');
